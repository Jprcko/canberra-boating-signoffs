    ...
    <div className="space-y-6 p-6 bg-white border border-gray-200 rounded-lg shadow-sm">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="space-y-4">
          ...
          <div>
            <Label htmlFor={`dateOfBirth-${index}`} className="text-sm font-medium block mb-2">
              Date of Birth * <span className="text-sm text-gray-500">(click to select)</span>
            </Label>
            <Popover>
              <PopoverTrigger asChild>
                <Button
                  ...
                  className={cn(
                    "w-full mt-1 justify-start text-left font-normal border-2",
                    !participant.dateOfBirth && "text-muted-foreground border-gray-300",
                    participant.dateOfBirth && "border-blue-400"
                  )}
                >
      ...
      {participant.dateOfBirth && 
       ...
       calculateAge(participant.dateOfBirth) < 16 && (
        <div className="mt-6 pt-4 border-t bg-amber-50 p-4 rounded-md">
          <div className="flex items-start space-x-2">
            ...
            >
              I confirm that an adult will be present during the session. This is required for participants under 16 years of age.
            </label>
          </div>
        </div>
      )}
