...
import { enGB } from "date-fns/locale";   // ← from date-fns, not react-day-picker
...
export function Calendar({
  ...
  locale = enGB,            // ← date-fns locale
  ...props
}: CalendarProps) {
  return (
    <DayPicker
      showOutsideDays={showOutsideDays}
      locale={locale}         // ← Monday/Friday/etc from enGB
      weekStartsOn={1}        // ← ensure Monday is first column
